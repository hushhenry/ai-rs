...
impl Adapter for FireworksAdapter {
	...
	fn to_web_request_data(
		...
		// NOTE: The `zeroai` strategy is to set a large max_tokens value, letting the model enforce its own lower limit by default to avoid unpleasant and confusing surprises.
